                ...
                <form id="addmovie" title="addmovie" action="Controller" method="post">
                    ...
                    <div class="col-lg-6 col-xs-12 col-md-4">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea required type="text" id="description" name="description" placeholder=""
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" id="country" name="country" placeholder="" class="input-xlarge" pattern="[A-Za-z][\w ]{1,56}$" required>
                            </div>
                        </div>
                        <div class="space"></div>
                        <div class="control-group">
